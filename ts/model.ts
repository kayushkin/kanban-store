...
//
// Generated from github.com/kayushkin/kanban-store @ f5f00ca0bbfd1d2cc4d77868af66f5c8f85f5038-dirty
...
import type { File as FileStoreFile } from "@kayushkin/file-store-types";
import type { ClassificationTaxonomy as LLMBridgeClassificationTaxonomy } from "@kayushkin/llm-bridge-types";
 ...
 */
export const EventAssignmentSkipped: EventKind = "assignment_skipped";
/**
 ...
 */
export const EventAttachmentAdded: EventKind = "attachment_added";
/**
 * EventAttachmentAdded and EventAttachmentRemoved are a file being put on a
 * card or taken off it. Like an assignment they have no kind-level clock
 * state: a file says nothing about whether the work is runnable, so the event
 * carries the state the card was already in.
 */
export const EventAttachmentRemoved: EventKind = "attachment_removed";
/**
...
export interface Board {
   ...
   */
  assignment_pool?: AssignmentPool;
  /**
   ...
   */
  taxonomy?: LLMBridgeClassificationTaxonomy;
  created_at: string;
  updated_at: string;
}
/**
 ...
 */
export type AssignmentStrategy = string;
/**
 ...
 */
export const AssignmentStrategyLeastOpenCards: AssignmentStrategy = "least_open_cards";
/**
 ...
 */
export const AssignmentStrategyRoundRobin: AssignmentStrategy = "round_robin";
/**
 ...
 */
export interface TicketLogEntry extends TicketView {
  /**
